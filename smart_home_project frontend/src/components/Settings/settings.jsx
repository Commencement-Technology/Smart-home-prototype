...
function Settings(){
  ...
  <div className="grid grid-cols-2 gap-2 max-w-xl m-auto">
    ...
    <div className="col-span-2 lg:col-span-1">
      <input type="text" id="name" className="border border-solid border-black rounded-[24px] px-[12px] py-[3px] md:text-[22.5px] w-full" onChange={handledevicedata} placeholder="Name"/>
    </div>

    <div className="col-span-2 lg:col-span-1">
      <input type="text" id="image" className="border border-solid border-black rounded-[24px] px-[12px] py-[3px] md:text-[22.5px] w-full" onChange={handledevicedata} placeholder="image url"/>
    </div>
        
    <div className="col-span-2 lg:col-span-1">
      <select id="location" value={formdata.location}  className="border border-solid border-black rounded-[24px] px-[12px] py-[3px] md:text-[22.5px] " onChange={handledevicedata}>
    ...
    <div className="col-span-2 text-right">
      <button disabled={Object.keys(formdata).length !== 3} className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded-full text-xs w-full sm:w-14 ">
        Add
      </button>
    </div>
